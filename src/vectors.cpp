...
#define VECTOR_ITERATORS 	scalar_type * begin () {return components[0]; } 						\
							scalar_type * end () {return components[dimension - 1]; } 				\
							scalar_type const * begin () const {return components[0]; } 			\
							scalar_type const * end () const {return components[dimension - 1];} 	\
							/* This line ends multiline macro. */
...
namespace vector
{
	...
	template<typename TVector3> TVector3		cross(TVector3 lhs, TVector3 rhs);
}

template<typename TVector> Scalar<TVector>
...
template<typename TVector3> TVector3
vector::cross(TVector3 lhs, TVector3 rhs)
{
	lhs = {
