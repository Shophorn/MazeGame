...
internal char const * fsvulkan_format_string(VkFormat format)
{
	switch (format)
	{
		...
		// Todo(Leo): These were not found by compiler, doesn't matter I don't need them now...
		...
		// Note(Leo): These are duplicates, can we still do something
...
internal char const * fsvulkan_color_space_khr_string(VkColorSpaceKHR colorSpace)
{
	switch(colorSpace)
	{
